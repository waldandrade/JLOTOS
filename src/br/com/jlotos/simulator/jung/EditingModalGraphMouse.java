...
public class EditingModalGraphMouse<V,E> extends AbstractModalGraphMouse 
	...
	protected JLotosGraphMousePlugin<V,E> editingPlugin;
    ...
    protected void loadPlugins() {
		...
		editingPlugin = new JLotosGraphMousePlugin<V,E>(vertexFactory, edgeFactory);
		add(scalingPlugin);
	 ...
	 */
	public JLotosGraphMousePlugin<V, E> getEditingPlugin() {
